...
import type { INtotice, INoticeResponse } from '../../../../model/Support/INotice';
...
export const NoticeMain = () => {
  ...
  const seearchList = (cPage?:number) => {
    ...
    axios.post('/api/support/noticeListBody.do', searchParam).then((res: AxiosResponse<INoticeResponse>) => {
