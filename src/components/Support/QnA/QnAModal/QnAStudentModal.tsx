...
export const QnAStudentModal: FC<IQnAModalProps> = ({ detail, searchList }) => {
          ...
          <table className="mb-4 w-full border border-gray-300">
            <tbody>
              ...
              <tr>
                ...
                <td className="min-h-[150px] border border-gray-300 px-2 py-4 align-top leading-relaxed whitespace-pre-wrap">
                  {detail.qnaContent}
                </td>
              </tr>
            </tbody>
